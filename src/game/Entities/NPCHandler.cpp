...
#ifdef BUILD_ELUNA
        // used by eluna
        sEluna->HandleGossipSelectOption(GetPlayer(), pItem, GetPlayer()->GetPlayerMenu()->GossipOptionSender(gossipListId), GetPlayer()->GetPlayerMenu()->GossipOptionAction(gossipListId), code);
#endif
    }
#ifdef BUILD_ELUNA

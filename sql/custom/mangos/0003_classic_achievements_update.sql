...
-- new achievement
INSERT INTO `achievement_dbc` (`ID`, `Faction`, `Instance_Id`, `Title_Lang_enUS`, `Description_Lang_enUS`, `Category`, `Points`, `Ui_Order`, `IconID`) VALUES ('982', '-1', '-1', 'A Mask for All Occasions', 'Collect the 20 unique Flimsy Masks listed below.', '158', '20', '22', '2953');
-- new criteria
